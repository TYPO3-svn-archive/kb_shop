...
CREATE TABLE tx_kbshop_category (
	...
	noTabs tinyint(4) unsigned DEFAULT '0' NOT NULL,
	saveAndNew tinyint(4) unsigned DEFAULT '0' NOT NULL,
	tcaTable tinyint(4) unsigned DEFAULT '0' NOT NULL,
	fecruser_prop int(11) unsigned DEFAULT '0' NOT NULL,
	fecruser_lock int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_kbshop_belist'
#
CREATE TABLE tx_kbshop_belist (
	uid int(11) unsigned DEFAULT '0' NOT NULL auto_increment,
	pid int(11) unsigned DEFAULT '0' NOT NULL,
	tstamp int(11) unsigned DEFAULT '0' NOT NULL,
	crdate int(11) unsigned DEFAULT '0' NOT NULL,
	...
	alias tinytext NOT NULL,
	description text NOT NULL,
	tablenr int(11) DEFAULT '0' NOT NULL,
	icon blob NOT NULL,
	listprops int(11) DEFAULT '0' NOT NULL,
	permaprops int(11) DEFAULT '0' NOT NULL,
	defsortprop int(11) DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_kbshop_belist_listprops_mm'
# 
#
CREATE TABLE tx_kbshop_belist_listprops_mm (
  uid_local int(11) unsigned DEFAULT '0' NOT NULL,
  uid_foreign int(11) unsigned DEFAULT '0' NOT NULL,
  tablenames varchar(30) DEFAULT '' NOT NULL,
  sorting int(11) unsigned DEFAULT '0' NOT NULL,
...
#
# Table structure for table 'tx_kbshop_belist_permaprops_mm'
# 
#
CREATE TABLE tx_kbshop_belist_permaprops_mm (
  uid_local int(11) unsigned DEFAULT '0' NOT NULL,
  uid_foreign int(11) unsigned DEFAULT '0' NOT NULL,
  tablenames varchar(30) DEFAULT '' NOT NULL,
  sorting int(11) unsigned DEFAULT '0' NOT NULL,
